 ...
 * 
 */
public class GroupFormEditor extends AbstractFormEditor {
	public static final long serialVersionUID = 0;

	public GroupFormEditor(SourceEditorMediator mediator, DOMTreeSource source, Node node,
