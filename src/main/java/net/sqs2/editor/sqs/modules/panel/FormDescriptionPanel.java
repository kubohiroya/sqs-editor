 ...
 * 
 */
public class FormDescriptionPanel extends AbstractSingleNodeEditorPanel {
	public static final long serialVersionUID = 0;

	public FormDescriptionPanel(AbstractNodeEditor editor) {
		super(editor);
		setBorder(new TitledBorder(EditorUtil.LOWERED_BORDER, getDescriptionLabel()));
	}

	public String getDescriptionXPath() {
		return "xforms:hint/text()";
	}

	public String getDescriptionLabel() {
		return Messages.FORM_HINT_LABEL;
	}
